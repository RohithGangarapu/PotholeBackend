...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-3j2h+lfm!xcg)gz+4%ip9m+((*ikwzn*&vi3-f(gb@)gwxk77_')
...
SPECTACULAR_SETTINGS = {
    ...
    'DESCRIPTION': 'Comprehensive REST API for Pothole Detection System with PostgreSQL integration. '
                   'Manage users, IOT devices, potholes, and alerts.',
    'VERSION': '1.0.0',
    ...
    'TAGS': [
        ...
        {'name': 'Alerts', 'description': 'Alert notification system'},
    ],
}
